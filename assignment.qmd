...
combined <- full_join(primary_dem, primary_rep)
...
combined_precinct <- combined_precinct %>%
  mutate(total_votes = (early_votes + provisional_votes + election_night_votes + mail_in_ballot_1_votes + mail_in_ballot_2_votes))
...
#I would need to know their population and whether it was large enough to make the lack of voters significant.
...
#Which precinct had the highest number of total votes, not just governor votes? Precinct 15005 had the highest number of total votes.
